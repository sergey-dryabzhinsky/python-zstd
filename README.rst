...
.. |releaseW| image:: https://github.com/sergey-dryabzhinsky/python-zstd/actions/workflows/build-wheels.yml/badge.svg?tag=v1.5.6.6
...
+----------------------+---------------------+
| cpython 3.9 x64 u20  | |cpython39x64|      |
+----------------------+---------------------+
